      ...
      {!showRoleSelection ? (
        <div className="relative z-10 flex flex-col items-center animate-in fade-in zoom-in-90 duration-1000">
          <div className="mb-12 relative">
            <div className="absolute inset-0 bg-[#FFFFFF]/20 blur-[40px] rounded-full scale-150" />
            <img
          ...
          <div className="flex flex-col items-center gap-8">
            <div className="h-[2px] w-16 bg-[#8B9A71] rounded-full">
              <div className="h-full bg-[#FFFFFF] w-full animate-[shimmer_2s_infinite]" />
            </div>
        ...
        <div className="w-full max-w-md relative z-10 animate-in fade-in slide-in-from-bottom-12 duration-1000">
          <div className="text-center mb-16">
            <div className="inline-block p-4 bg-[#FFFFFF]/5 backdrop-blur-xl rounded-[32px] border border-[#FFFFFF]/10 mb-10 shadow-2xl">
              <img
                src="/img/Lifeandyou-logo-1.png"
                alt="Life & You"
            ...
            <h1 className="text-4xl md:text-5xl font-black text-[#FFFFFF] mb-4 tracking-tighter leading-tight">
              <span style={{ color: '#FFFFFF' }}>Begin your</span>{" "}
              <span className="text-[#8B9A71]">Safe Session.</span>
            </h1>
          ...
          <div className="space-y-4">
            ...
            <button
              ...
              className="w-full bg-[#FFFFFF]/10 backdrop-blur-3xl border border-[#FFFFFF]/10 rounded-[32px] p-7 flex items-center gap-6 group hover:bg-[#FFFFFF] transition-all shadow-2xl hover:scale-[1.02] active:scale-[0.98] text-left"
            >
              <div className="w-14 h-14 bg-[#8B9A71] rounded-[20px] flex items-center justify-center text-[#2D3324] shadow-xl group-hover:rotate-6 transition-transform shrink-0">
                <User size={26} strokeWidth={2.5} />
              </div>
              <div className="flex-1 min-w-0">
                <h3 className="text-xl font-black !text-[#FFFFFF] group-hover:!text-[#2D3324] transition-colors tracking-tight">
                  Client
                </h3>
                <p className="text-xs text-[#CED2BA] group-hover:text-[#2D3324]/60 font-bold uppercase tracking-widest mt-1">
                  Seek Transformation
                </p>
              </div>
              <div className="w-10 h-10 border border-[#FFFFFF]/20 rounded-full flex items-center justify-center group-hover:bg-[#2D3324] group-hover:border-transparent transition-all shrink-0">
                <ArrowRight size={18} className="text-[#FFFFFF] group-hover:scale-110 transition-transform" />
              </div>
            </button>
            ...
            <button
              ...
              className="w-full bg-[#1A1D14] border border-[#8B9A71]/20 rounded-[32px] p-7 flex items-center gap-6 group hover:bg-[#8B9A71] transition-all shadow-2xl hover:scale-[1.02] active:scale-[0.98] text-left"
            >
              <div className="w-14 h-14 bg-[#FFFFFF]/5 border border-[#FFFFFF]/10 rounded-[20px] flex items-center justify-center group-hover:bg-[#2D3324] transition-all shrink-0">
                <ShieldCheck size={26} strokeWidth={2.5} className="text-[#8B9A71] group-hover:text-[#FFFFFF]" />
              </div>
              <div className="flex-1 min-w-0">
                <h3 className="text-xl font-black !text-[#FFFFFF] group-hover:!text-[#2D3324] transition-colors tracking-tight">
                  Coach
                </h3>
                <p className="text-xs text-[#FFFFFF]/40 group-hover:text-[#2D3324]/60 font-bold uppercase tracking-widest mt-1">
                  Lead with Wisdom
                </p>
              </div>
              <div className="w-10 h-10 border border-[#8B9A71]/40 rounded-full flex items-center justify-center group-hover:bg-[#2D3324] group-hover:border-transparent transition-all shrink-0">
                <ArrowRight size={18} className="text-[#8B9A71] group-hover:text-[#FFFFFF] transition-transform" />
              </div>
            </button>
          </div>
