...
export function SplashPage() {
  ...
  return (
    <div className="min-h-screen bg-[#2D3324] flex flex-col items-center justify-center p-6 relative overflow-hidden font-['SUSE']">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-[#A68A45] rounded-full filter blur-[100px] opacity-10 animate-pulse delay-500" />
        ...
        <div className="w-full max-w-md relative z-10 animate-in fade-in slide-in-from-bottom-12 duration-1000">
          <div className="text-center mb-16">
            ...
            <h1 className="text-4xl md:text-5xl font-black text-[#FFFFFF] mb-4 tracking-tighter leading-tight">
              <span style={{ color: '#FFFFFF' }}>Begin your</span> <span className="text-[#8B9A71]">Safe Session.</span>
            </h1>
          ...
          <div className="space-y-6">
            ...
            <button
              ...
              className="w-full bg-[#FFFFFF]/10 backdrop-blur-3xl border border-[#FFFFFF]/10 rounded-[32px] p-8 flex items-center gap-8 group hover:bg-[#FFFFFF] transition-all shadow-2xl hover:scale-[1.02] active:scale-[0.98] text-left"
            >
              ...
              <div className="flex-1">
                <h3 className="text-xl font-black !text-[#FFFFFF] group-hover:!text-[#2D3324] transition-colors tracking-tight">Enter as Client</h3>
              ...
              <div className="w-10 h-10 border border-[#FFFFFF]/20 rounded-full flex items-center justify-center group-hover:bg-[#2D3324] group-hover:border-[#00000000] transition-all">
                <ArrowRight size={20} className="text-[#FFFFFF] group-hover:scale-110 transition-transform" />
              </div>
            </button>
            ...
            >
              <div className="w-16 h-16 bg-[#FFFFFF]/5 border border-[#FFFFFF]/10 rounded-[24px] flex items-center justify-center text-[#FFFFFF] group-hover:bg-[#2D3324] transition-all">
                <ShieldCheck size={32} strokeWidth={3} className="text-[#8B9A71] group-hover:text-[#FFFFFF]" />
              </div>
              <div className="flex-1">
                <h3 className="text-xl font-black !text-[#FFFFFF] group-hover:!text-[#2D3324] transition-colors tracking-tight">Join as Expert</h3>
                <p className="text-xs text-[#FFFFFF]/40 group-hover:text-[#2D3324]/60 font-bold uppercase tracking-widest mt-1">Lead with Wisdom</p>
              </div>
              <div className="w-10 h-10 border border-[#8B9A71]/40 rounded-full flex items-center justify-center group-hover:bg-[#2D3324] transition-all">
                <ArrowRight size={20} className="text-[#8B9A71] group-hover:text-[#FFFFFF] transition-transform" />
              </div>
            </button>
          </div>
