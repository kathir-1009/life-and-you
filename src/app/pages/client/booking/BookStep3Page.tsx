    ...
    <div className="min-h-screen bg-[#FFFFFF] pb-32 portal-context">
      ...
      <div className="lg:hidden bg-[#2D3324] text-white px-6 py-6 rounded-b-[40px] relative overflow-hidden flex items-center gap-4 shadow-xl z-20">
         ...
         <div className="relative z-10 flex-1">
            <h1 className="text-xl font-black tracking-tight leading-none text-[#FFFFFF]">Confirm Booking</h1>
            <p className="text-[#8B9A71] text-[9px] font-black uppercase tracking-[0.2em] mt-1">Last step to your breakthrough</p>
         </div>
      </div>
