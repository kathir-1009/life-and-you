  ...
  return (
    <div className="min-h-screen bg-[#FCF8E8] pb-32 portal-context">
      <div className="max-w-xl mx-auto px-6 pt-16 text-center">
        ...
        <div className="bg-[#FFFFFF] p-10 rounded-[48px] border border-[#99A88C]/10 shadow-2xl mb-12 text-left">
           ...
           <div className="mt-12 pt-8 border-t border-[#99A88C]/10 text-center">
              ...
              <Link 
                to="/confirmation" 
                className="w-full py-6 bg-[#99A88C] text-[#FFFFFF] rounded-full font-bold text-xs uppercase tracking-widest hover:scale-[1.03] shadow-2xl transition-all block"
              >
