    ...
    <div className="min-h-screen bg-[#FCF8E8] pb-32 portal-context">
      <div className="max-w-4xl mx-auto px-6 pt-16">
        ...
        <div className="grid lg:grid-cols-12 gap-12">
           <div className="lg:col-span-7 bg-white p-10 rounded-[48px] border border-[#99A88C]/10 shadow-sm text-center">
                 ...
                 {[...Array(31)].map((_, i) => (
                    <button 
                      ...
                      className={`w-10 h-10 rounded-2xl flex items-center justify-center text-xs font-bold transition-all ${
                        i === 13 ? 'bg-[#99A88C] text-white shadow-lg' : 'hover:bg-[#FCF8E8] text-[#5E6C54]'
                      }`}
                    >
                      {i + 1}
                    </button>
           ...
           <div className="lg:col-span-5 space-y-6">
                 ...
                 {times.map(time => (
                    <button 
                      ...
                      className={`w-full p-6 rounded-[32px] border-2 transition-all font-bold text-sm tracking-tight ${
                        selectedTime === time 
                          ? 'bg-[#99A88C] border-transparent text-white shadow-xl' 
                          : 'bg-white border-[#99A88C]/10 text-[#5E6C54] hover:border-[#99A88C]/40'
                      }`}
                    >
                       {time}
                    </button>
              ...
              <Link 
                ...
                className={`w-full mt-10 py-6 bg-[#5E6C54] text-white rounded-full font-bold text-xs uppercase tracking-widest transition-all text-center block ${!selectedTime ? 'opacity-50 pointer-events-none' : 'hover:scale-105 shadow-2xl'}`}
              >
