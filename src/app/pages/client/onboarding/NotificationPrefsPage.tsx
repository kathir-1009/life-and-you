      ...
      <div className="max-w-xl w-full">
        ...
        <div className="flex items-center justify-between">
          ...
          <Link 
            ...
            className="px-10 py-5 bg-[#5E6C54] text-white rounded-full font-bold text-xs uppercase tracking-widest hover:scale-105 shadow-xl transition-all flex items-center gap-3"
          >
...
function NotificationToggle({ label, desc, defaultOn }: { label: string, desc: string, defaultOn: boolean }) {
  return (
    <div className="bg-white p-6 rounded-[32px] border border-[#99A88C]/5 flex items-center justify-between text-left group hover:border-[#99A88C]/20 transition-all">
       <div>
