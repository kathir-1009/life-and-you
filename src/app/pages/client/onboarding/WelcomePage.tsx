...
export function ClientWelcomePage() {
  return (
    <div className="min-h-screen bg-[#FCF8E8] flex flex-col items-center justify-center p-6 text-center">
      ...
      <Link 
        to="/onboarding/goals" 
        className="px-12 py-5 bg-[#99A88C] text-[#FFFFFF] rounded-full font-bold text-xs uppercase tracking-widest shadow-xl hover:scale-105 transition-all flex items-center gap-3"
      >
