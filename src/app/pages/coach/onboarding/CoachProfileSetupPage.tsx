      ...
      <div className="max-w-2xl w-full bg-white p-12 rounded-[60px] border border-sage/10 shadow-sm">
        ...
        <div className="space-y-6 text-left mb-12">
           ...
           <div className="flex flex-col gap-2">
              ...
              <textarea 
                className="w-full bg-cream border border-transparent rounded-[24px] p-6 text-sm text-sage-dark focus:bg-white focus:border-sage/30 transition-all outline-none min-h-[120px]"
