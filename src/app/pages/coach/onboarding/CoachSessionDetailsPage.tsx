                 ...
                 <div className="flex flex-col gap-6">
                    ...
                    <div className="flex flex-wrap gap-4">
                       {['Video Call', 'Audio Call', 'Chat Coaching'].map(type => (
                         <label key={type} className="flex items-center gap-4 p-4 bg-[#F3F5F0] rounded-2xl border border-[#8B9A71]/20 cursor-pointer transition-all hover:bg-white has-[:checked]:bg-[#8B9A71]/20 has-[:checked]:border-[#8B9A71]/30 group">
                 ...
                 <div className="flex flex-col gap-6">
                    ...
                    <div className="flex flex-wrap gap-3">
                       {['30 min', '45 min', '60 min', '90 min'].map(dur => (
                         <label key={dur} className="flex items-center gap-4 p-4 bg-[#F3F5F0] rounded-2xl border border-[#8B9A71]/20 cursor-pointer transition-all hover:bg-white has-[:checked]:bg-[#8B9A71]/20 has-[:checked]:border-[#8B9A71]/30 group">
                            <div className="relative w-5 h-5 shrink-0">
                               <input type="checkbox" className="peer absolute inset-0 opacity-0 cursor-pointer z-10" />
                               <div className="absolute inset-0 bg-white border-2 border-[#8B9A71]/20 rounded-lg transition-all peer-checked:bg-[#2D3324] peer-checked:border-[#2D3324] flex items-center justify-center">
                                  <svg className="w-3 h-3 text-white scale-0 peer-checked:scale-100 transition-transform duration-200" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="5">
              ...
              <div className="flex flex-col gap-6">
                 ...
                 <div className="flex flex-wrap gap-3">
                    {['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'].map(day => (
                      <label key={day} className="flex items-center justify-center w-14 h-14 bg-[#F3F5F0] rounded-2xl border border-[#8B9A71]/20 cursor-pointer transition-all hover:bg-white has-[:checked]:bg-[#2D3324] has-[:checked]:text-white has-[:checked]:shadow-xl has-[:checked]:border-transparent">
