...
export function CoachAddSchedulePage() {
  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-5 duration-700 px-4 md:px-0 pb-32">
      <div className="max-w-2xl mx-auto">
        <button 
          onClick={() => navigate(-1)}
          className="flex items-center gap-2 !text-[#5E6C54] hover:!text-[#99A88C] transition-colors mb-6 md:mb-8 text-[11px] md:text-xs font-black uppercase tracking-widest"
          style={{ color: '#5E6C54' }}
        >
        ...
        <div className="bg-white rounded-[32px] md:rounded-[48px] border border-sage/10 shadow-xl p-6 md:p-12">
          <div className="mb-6 md:mb-10 text-center md:text-left portal-context">
          ...
          {isSaved ? (
            <div className="py-20 text-center animate-in zoom-in duration-500 portal-context">
            ...
            <form onSubmit={handleSave} className="space-y-6 md:space-y-8 portal-context">
