    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-5 duration-700 px-4 md:px-0 portal-context pb-20">
        ...
        <div className="flex items-center gap-3">
           <div className="relative flex-1 lg:w-72">
              ...
              <input 
                ...
                className="w-full bg-[#FFFFFF] border border-[#99A88C]/10 pl-12 pr-4 py-3 rounded-2xl text-xs outline-none focus:border-[#A68A45] transition-all"
              />
           </div>
           <button className="p-3 bg-[#FFFFFF] border border-[#99A88C]/10 rounded-2xl text-[#5E6C54] hover:bg-[#FCF8E8] transition-colors">
              <Filter size={18} />
           </button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
         {filteredSessions.map((session) => (
           <div key={session.id} className="bg-[#FFFFFF] rounded-[32px] p-6 lg:p-8 border border-[#99A88C]/5 shadow-sm hover:shadow-xl transition-all group flex flex-col justify-between">
              <div>
                 <div className="flex items-center justify-between mb-8">
                    <div className="flex items-center gap-3">
                       <div className="w-10 h-10 bg-[#D0D9CD] rounded-xl flex items-center justify-center text-[#5E6C54]">
                          <Calendar size={18} />
                       </div>
                       <div>
              ...
              <div className="pt-6 border-t border-[#FCF8E8] flex items-center justify-between">
                 <div className="flex items-center gap-2">
                    <div className={`w-2 h-2 rounded-full ${session.isUpcoming ? 'bg-[#22C55E] animate-pulse' : 'bg-[#99A88C]/20'}`} />
                 ...
                 {session.isUpcoming ? (
                   <Link 
                     ...
                     className="px-6 py-2.5 bg-[#99A88C] text-[#FFFFFF] rounded-xl text-[10px] font-black uppercase tracking-widest shadow-lg shadow-[#99A88C]/10 hover:bg-[#99A88C] transition-all flex items-center gap-2"
                   >
         ...
         {tab === 'upcoming' && (
           <Link 
             to="/portal/book"
             className="border-2 border-dashed border-[#99A88C]/20 rounded-[32px] p-8 flex flex-col items-center justify-center text-center gap-4 group hover:border-[#99A88C]/40 hover:bg-[#FFFFFF] transition-all min-h-[280px]"
           >
