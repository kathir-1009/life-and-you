      ...
      <div className="max-w-md w-full relative z-10">
        ...
        <div className="bg-white p-8 md:p-10 rounded-[40px] shadow-2xl">
          <div className="text-center mb-10">
            <h1 className="text-3xl font-bold text-[#2D3324] font-serif mb-2">Create Account</h1>
            <p className="text-[#2D3324]/50 text-sm font-medium">Join Life & You — start your first session today</p>
          </div>
          ...
          <form className="space-y-4" onSubmit={handleAuth}>
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <input type="text" required placeholder="Your name" className="w-full bg-[#F3F5F0] border border-[#8B9A71]/20 rounded-2xl pl-12 pr-4 py-4 text-sm text-[#2D3324] outline-none focus:border-[#8B9A71] focus:bg-white transition-[background-color,border-color] duration-200 placeholder:text-[#2D3324]/30" />
              </div>
            </div>
            ...
            <div className="mt-4 text-center text-[10px] font-medium text-[#2D3324]/50">
              ...
              <Link to="/auth/client/login" className="text-[#8B9A71] font-bold hover:text-[#2D3324] transition-colors uppercase tracking-widest">
                Sign In
              </Link>
            </div>
          </form>
