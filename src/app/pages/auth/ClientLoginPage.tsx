      ...
      <div className="max-w-md w-full relative z-10">
        ...
        <div className="bg-white p-8 md:p-10 rounded-[40px] shadow-2xl">
          <div className="text-center mb-10">
            <h1 className="text-3xl font-bold text-[#2D3324] font-serif mb-2">Welcome Back</h1>
          ...
          <form className="space-y-4" onSubmit={handleAuth}>
            ...
            <div className="mt-4 text-center text-[10px] font-medium text-[#2D3324]/50">
              ...
              <Link to="/auth/client/register" className="text-[#8B9A71] font-bold hover:text-[#2D3324] transition-colors uppercase tracking-widest">
                Register
              </Link>
            </div>
          </form>
