       ...
       <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="flex flex-col lg:flex-row lg:items-end justify-between mb-20 gap-8">
             <div className="max-w-2xl">
                <span className="text-[10px] font-black text-gold-dark uppercase tracking-[0.4em] mb-4 block">Our Offerings</span>
                <h2 className="text-4xl md:text-6xl font-bold text-sage-dark font-serif">Tailored Growth <span className="text-gold-dark">Programs.</span></h2>
             </div>
             <Link to="/programs" className="px-8 py-4 bg-white border border-sage/10 rounded-2xl text-[10px] font-black uppercase tracking-[0.2em] shadow-sm hover:scale-105 transition-all">
                View Full Catalog
             </Link>
          </div>
