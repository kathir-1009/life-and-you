...
export function UpcomingSession() {
  return (
    <div className="bg-sage rounded-[32px] p-8 text-white relative overflow-hidden shadow-2xl">
       ...
       <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-8">
          ...
          <Link 
            to="/session/next" 
            className="px-8 py-4 bg-gold text-sage-dark rounded-2xl font-bold uppercase tracking-widest hover:scale-105 transition-transform text-center shadow-lg shadow-black/20"
          >
            Join Room
          </Link>
       </div>
