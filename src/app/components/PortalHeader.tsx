...
export function PortalHeader() {
  ...
  return (
    <header className="hidden lg:block relative font-sans-app">
      ...
      <div className="absolute inset-x-0 top-0 h-56 bg-gradient-to-r from-[#1C2320] via-[#1C2320] to-[#2D3324] overflow-hidden z-0">
         <div className="absolute inset-0 bg-[url('/img/bg/pattern-bg.png')] opacity-20 mix-blend-overlay" />
         <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-[#A68A45]/10 rounded-full blur-[120px]" />
         <div className="absolute bottom-0 left-1/4 w-[400px] h-[400px] bg-[#3D5247]/20 rounded-full blur-[100px]" />
      </div>
      ...
      <div className="max-w-[1440px] mx-auto px-10 relative z-10">
        ...
        <div className="h-24 flex items-center justify-between">
            <Link to="/" className="flex items-center gap-4 group">
               ...
               <div>
                  ...
                  <p className="text-[10px] font-black text-[#A68A45] uppercase tracking-[0.3em] mt-1.5">Sanctuary Portal</p>
               </div>
            </Link>
            ...
            <div className="flex items-center gap-10">
               ...
               <div className="flex items-center gap-5">
                  <div className="text-right">
                     ...
                     <p className="text-[10px] text-[#A68A45] font-black uppercase tracking-widest mt-1.5 opacity-90">{role} Access</p>
                  </div>
                  <div className="relative group/avatar">
                    ...
                    <div className="absolute -bottom-1 -right-1 w-4 h-4 bg-green-500 border-2 border-[#1C2320] rounded-full" />
                  </div>
                  <button 
        ...
        <div className="mt-4 translate-y-6 relative z-20">
           <div className="bg-white rounded-[24px] shadow-[0_20px_50px_rgba(0,0,0,0.1)] border border-[#3D5247]/5 p-2 flex items-center justify-between">
              ...
              <div className="pr-8 pl-4">
                 <Link 
                   to="/portal/book" 
                   className="bg-gradient-to-r from-[#3D5247] to-[#2D3324] text-white px-8 py-3.5 rounded-full text-xs font-bold uppercase tracking-widest shadow-xl hover:scale-[1.03] transition-all block focus:ring-4 ring-[#3D5247]/20"
                 >
                   Instant Booking
                 </Link>
              </div>
